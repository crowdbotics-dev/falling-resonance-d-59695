...
## Project Structure
    ...
    ├── falling_resonance_d_59695  # Django project configurations
...
1. Clone this repo and `cd falling_resonance_d_59695`
...
2. Clone this repo and `cd falling_resonance_d_59695`
